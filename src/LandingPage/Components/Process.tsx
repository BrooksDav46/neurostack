  ...
  const steps = [
    {
      step: "01",
      title: "Strategy Call",
      desc: "Quick call to understand your goals, market, and what’s needed to generate more leads fast.",
    },
    {
      step: "02",
      title: "Audit + Game Plan",
      desc: "We review your website, Google presence, and competitors, then map the plan for SEO and/or Ads.",
    },
    {
      step: "03",
      title: "Build the Foundation",
      desc: "We create or improve your site/landing pages, messaging, and conversion flow so clicks turn into leads.",
    },
    {
      step: "04",
      title: "Launch SEO + Google Ads",
      desc: "We set up tracking, launch campaigns, and optimize targeting so you start getting measurable results.",
    },
    {
      step: "05",
      title: "Optimize + Scale",
      desc: "Ongoing improvements to rankings, ads, and conversions—so performance increases month over month.",
    },
  ];
    ...
    <section className="relative -mt-10 sm:-mt-14">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-3 text-sm leading-relaxed text-white/70 sm:text-base">
          A clear workflow designed to launch fast, track performance, and scale what works.
        </p>
      </div>
      ...
      <div className="relative mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
        {steps.map((s, i) => {
          const stagger = i === 1 ? "lg:translate-y-4" : i === 3 ? "lg:-translate-y-4" : "";
          ...
          return (
            ...
            >
              {/* premium border brighten on hover */}
              <div className="pointer-events-none absolute -inset-px rounded-2xl opacity-0 transition duration-300 group-hover:opacity-100">
                <div
                  ...
                  style={{
                    ...
                    boxShadow: "0 0 0 1px rgba(34,211,238,0.22), 0 0 22px rgba(168,85,247,0.08)",
                  }}
                />
              </div>
              ...
              <div className="relative px-6 py-6">
                ...
                <p className="mt-2 text-sm leading-relaxed text-white/68">{s.desc}</p>
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-3 text-xs text-white/70">
        {[
          ...
          <span
            ...
            "
            style={{ boxShadow: "0 0 18px rgba(168,85,247,0.06)" }}
          >
            {t}
          </span>
        ))}
